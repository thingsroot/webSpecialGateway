module.exports = {
    ...
    "rules": {
      ...
      "comma-spacing":2, //逗号后边加空格 
      "brace-style":2, //else 关键字要与花括号保持在同一行
      "curly":2, //多行 if 语句的的括号不能省
      "no-multiple-empty-lines":2, //不允许有连续多行空行
      "operator-linebreak":2, //对于三元运算符 ? 和 : 与他们所负责的代码处于同一行
      "comma-style":2, //始终将逗号置于行末
      "key-spacing":2, //键值对当中冒号与值之间要留空白
      "constructor-super":2, //子类的构造器中一定要调用 super
      "no-duplicate-imports":2, //一模块有多个导入时一次性写完
      "no-fallthrough":2, //witch 一定要使用 break 来将条件分支正常中断
    },
    "settings": {
      "import/ignore": [
        "node_modules"
